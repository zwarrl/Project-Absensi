...
<div class="sidebar">
    ...
    @if(auth()->user()->role === 'admin')
        <a href="{{ route('absensi.index') }}">📝 Absen Masuk</a>
        <a href="{{ route('students.index') }}">👥 Data Siswa</a>
        <a href="{{ route('absen_pulang.index') }}">📄 Absen Pulang</a>
    @elseif(auth()->user()->role === 'siswa')
        <a href="{{ route('absensi.create') }}">📝 Absen Masuk</a>
        <a href="{{ route('absensi.history') }}">📄 Riwayat Absensi</a>
    @endif
...
<div class="content">
    ...
    <div class="row mt-4 g-3">
        ...
        @elseif(auth()->user()->role === 'siswa')
            <div class="col-md-4">
                <div class="card p-4 shadow-sm card-stat">
                    <h6 class="text-muted">Total Absensi Anda</h6>
                    <h2 class="text-primary fw-bold">{{ $totalAbsensi }}</h2>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card p-4 shadow-sm card-stat">
